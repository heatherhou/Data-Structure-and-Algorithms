...
;
	...
	public void testToString()
	{
		...
		WordGram d = new WordGram (words, 1,0);

		assertEquals(a.toString(),"apple zebra mongoose hat");
		assertEquals(b.toString(),"zebra mongoose hat cat");
		assertEquals(c.toString(), "apple");
	...
	public void testShiftAdd()
	{
		...
		WordGram b = new WordGram (words, 1,0);
		WordGram c = new WordGram (words, 1,2);
		assertEquals(a.shiftAdd("hat").toString(),"zebra mongoose hat");
		assertEquals(a.shiftAdd("cat").toString(),"zebra mongoose cat");
		assertEquals(b.shiftAdd("apple").toString(), "");
		assertEquals(b.shiftAdd("").toString(),"");
		assertEquals(c.shiftAdd("hat").toString(),"mongoose hat");
		assertEquals(c.shiftAdd("").toString(),"mongoose ");
	}
}
